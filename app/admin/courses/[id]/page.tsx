...
import StudentModuleAccessModal from '@/components/StudentModuleAccessModal'
...
export default function AdminCoursePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [studentAccessOpen, setStudentAccessOpen] = useState(false)
  ...
  return (
    <div className="page-pad" style={{ padding: 28 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24, flexWrap: 'wrap' }}>
        ...
        <button
          onClick={() => setStudentAccessOpen(true)}
      ...
      <StudentModuleAccessModal
        open={studentAccessOpen}
        onClose={() => setStudentAccessOpen(false)}
        courseId={courseId}
        modules={modules}
      />
